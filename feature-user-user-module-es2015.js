...
FavoriteComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FavoriteComponent, selectors: [["app-favorite"]], decls: 5, vars: 1, consts: [[1, "category"], [1, "flex-box"], [4, "ngFor", "ngForOf"], [1, "products"], [3, "src"]], template: function FavoriteComponent_Template(rf, ctx) { if (rf & 1) {
